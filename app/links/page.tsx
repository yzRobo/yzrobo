...
const Navigation = () => (
  ...
  >
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 flex justify-between items-center max-w-7xl">
      <a href="/" className="text-xl sm:text-2xl font-bold tracking-tight group">
        <span className="text-white group-hover:text-gray-300 transition-colors">YZ</span>
...
const socialLinks = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 600 530" fill="currentColor" className="w-6 h-6">
...
const LinkCard = ({ link, index }: LinkCardProps) => {
  ...
  return (
    ...
    >
      <div className="relative p-6 sm:p-8 bg-gray-900/30 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-800 hover:border-gray-700 transition-all duration-300">
        {/* Hover glow effect */}
        <div 
        ...
        <div className="relative z-10 flex flex-col items-center text-center">
          ...
          <motion.div
            ...
            className="mb-4 p-4 rounded-2xl bg-white/5 text-white"
            style={{ 
              backgroundColor: isHovered ? `${link.color}20` : undefined,
              color: isHovered ? link.color : undefined,
              transition: 'all 0.3s'
            }}
          >
            {link.icon}
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="pt-24 md:pt-32 pb-12 md:pb-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
          ...
          >
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-display font-bold mb-4 md:mb-6 tracking-tight">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-2xl">
          ...
          >
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-2 px-5 sm:px-6 py-2.5 sm:py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium rounded-full transition-colors text-sm sm:text-base"
            >
