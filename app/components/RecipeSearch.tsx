                    ...
                    <div className="py-2">
                      {results.map((recipe, index) => (
                        <motion.button
                          ...
                          onKeyDown={(e) => handleKeyDown(e, recipe.slug)}
              ...
              {!query && (
                <div className="p-4 text-xs text-gray-500 border-t border-white/10">
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {['pasta', 'grilled', 'italian', 'bbq', 'easy'].map((term) => (
                      <button
                        key={term}
                        onClick={() => setQuery(term)}
                        className="px-2 py-1 bg-white/5 rounded hover:bg-white/10 transition-colors"
                      >
                        {term}
                      </button>
                    ))}
